...
<style type="text/css">
    ...
    .viewport-lg .header-logo {
        max-width: 180px;
    }

    .footer-1.footer-widget-section .footer-pattern {
        opacity: 0.5;
    }
    ...
    .footer-3.footer-widget-section .footer-bg {
        opacity: 0.5;
    }
</style>
...
<style id='global-styles-inline-css'>
    :root {
        ...
        --wp--preset--color--dark-gray: #0a0c19;
        --wp--preset--color--light-gray: #777;
